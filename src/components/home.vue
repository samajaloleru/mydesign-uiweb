<template>
        ...
        <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="navigation-example-2">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="components-description.html" class="btn btn-danger btn-simple">Components</a>
                    </li>
                    <li>
    ...
    <div class="wrapper">
        ...
        <div class="section section-light-blue">
            ...
            <!--                                       default dropdown -->
                                            <li class="dropdown">
                                                <button href="#" class="dropdown-toggle btn" data-toggle="dropdown">Default <b class="caret"></b></button>
                <!--                                  You can add classes for different colours on the next element -->
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                <li class="dropdown-header">Dropdown header</li>
                                                <li><a href="#">Action</a></li>
                    ...
                    <div id="images">
                        ...
                        <div class="row">
                            <div class="col-xs-8 col-sm-6 col-md-3">
                                <h4>Rounded Image</h4>
                                <img src="@/assets/img/thinking_in_textures.jpg" alt="Rounded Image" class="img-rounded img-responsive">
                            ...
                            <div class="col-xs-6  col-sm-3 col-md-2 col-md-offset-1">
                                <h4>Thumbnail</h4><br />
                                <img src="@/assets/img/chet_faker_2.jpg" alt="Thumbnail Image" class="img-thumbnail img-responsive">
        ...
        <div id="carousel">
            ...
            <div class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="@/assets/img/pencils.jpg" alt="Awesome Image">
                    </div>
                    <div class="item">
                    <img src="@/assets/img/shoes.jpg" alt="Awesome Image">
                    </div>
                    <div class="item">
                    <img src="@/assets/img/types.jpg" alt="Awesome Image">
                    </div>
                </div>
                    ...
                    <div class="row example-pages">
                        <div class="col-md-4">
                            <a href="examples/landing.html" target="_blank">
                                <img src="assets/img/examples/landing.jpg" alt="Rounded Image" class="img-rounded img-responsive">
                                <h5>Landing Page</h5>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="examples/register.html" target="_blank">
                                <img src="assets/img/examples/register.jpg" alt="Rounded Image" class="img-rounded img-responsive">
                                <h5>Register</h5>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="examples/profile.html" target="_blank">
                                <img src="assets/img/examples/profile.jpg" alt="Rounded Image" class="img-rounded img-responsive">
                                <h5>Profile</h5>
                            </a>
                        </div>
                    </div>
